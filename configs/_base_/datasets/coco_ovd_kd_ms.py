...
det_dataset = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='hchoi/instances_train2017_pseudo_v0_new_caption.json',
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file=data_root + 'hchoi/instances_val2017_base.json',
        metric='bbox',
        prefix='Base',
        format_only=False),
    dict(
        type='CocoMetric',
        ann_file=data_root + 'hchoi/instances_val2017_novel.json',
        metric='bbox',
        prefix='Novel',
        format_only=False)
]
