...
class_weight = 'data/metadata/lvis_v1_train_cat_norare_info_v0_new_caption.json'
...
ovd_cfg = dict(type='BaronKD',
               boxes_cache=dict(json_path='data/lvis_v1/hchoi/instances_train2017_pseudo_v0_new_caption.json',
                                start_iter=20000,),
               bg_cls_embeddings_path='data/metadata/lvis_v1_clip_detpro_background.npy',
               use_gt=True,
               bag_weight=1.0, single_weight=0.1, caption_weight=0.05, bg_weight=0.01, use_attn_mask=False, bag_temp=20.0, rta_tepm=5.0, single_temp=30.0,
