...
class SamAutomaticMaskGenerator:
    ...
    def generate(self, image: np.ndarray) -> List[Dict[str, Any]]:
        ...
        # Generate masks
        data_l = self._generate_masks_l(image)
        curr_anns_l = self.generate_curr_anns(data_l)
        return curr_anns_l
    ...
    def _generate_masks_l(self, image):
    ...
    def _generate_masks_data(self, data, crop_boxes) -> MaskData:
        if len(data["boxes"]) == 0:
            data.to_numpy()
            return data
    ...
    def _process_crop_l(self, image, crop_box, crop_layer_idx, orig_size):
    ...
    def _process_batch_l(self, points, im_size, crop_box, orig_size):
